...
public enum ClassTypes {
    ...
    LAMBDA("ЛЯМБДА-ВЫРАЖЕНИЕ.\n" +
            ...
            "        6. Вы должны разрешать любые конфликты между методами по умолчанию из нескольких интерфейсов.\n" +
            "\n" +
            "        ПРИМЕНЕНИЕ:\n" +
            "        Основная цель лямбда-выражений – использовать функционального подхода(функция, которая создаётся\n" +
            "        без привязки к классу..Технически, Л-В объявляется в анонимном классе) и уменьшить количество кода.\n"),
